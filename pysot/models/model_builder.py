...
from pysot.models.loss_main import make_loss_evaluator,Project
from pysot.models.backbone import get_backbone
from pysot.models.head.dmcf_head import DMCFHead
from pysot.models.neck import get_neck
from ..utils.location_grid import compute_locations
from pysot.utils.xcorr import xcorr_depthwise
# from pysot.utils.xcorr import DepthwiseXCorr
# from pysot.utils.xcorr import PixelwiseXCorr
from pysot.models.neck.neck import AdjustLayer


class ModelBuilder(nn.Module):
    def __init__(self, e_exemplars=4, sm_normalization=False, temperature=1, dropout=False):
        ...
        # self.xcorr_depthwise = DepthwiseXCorr(in_channels)
        ...
        if cfg.TRAIN.REG_MAX > 16:
            self.dmcf_head = self.car_head = DMCFHead(cfg, 256)
        else:
            self.car_head = DMCFHead(cfg, 256)
