...
# from siamese.tracker.siamfdb_tracker import SiamFDBTracker
...
parser = argparse.ArgumentParser(description='Siamese demo')
parser.add_argument('--video', default='', type=str, help='eval one special video')
parser.add_argument('--dataset_dir',default='D:\\sjj', type=str, help='dataset root directory')
parser.add_argument('--dataset',default='UAV123', type=str, help='dataset name')
parser.add_argument('--snapshot', type=str, default='E:/lwdm/SiamFDB-main/snapshotAll/checkpoint_e14.pth', help='model name')
...
parser.add_argument('--config', type=str, default='E:/lwdm/SiamFDB-main/experiments/SiamFDB_r50/config.yaml', help='config file')
