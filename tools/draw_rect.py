...
# parser.add_argument('--dataset_dir', type=str, default='D:\\sjj', help='dataset root directory')
# parser.add_argument('--dataset', type=str, default='OTB100', help='dataset name')
# parser.add_argument('--tracker_result_dir',default='E:/lwdm/SiamFDB-main/tools/results/OTB100/', type=str, help='tracker result root')
# parser.add_argument('--trackers', nargs='+', default="")
# parser.add_argument('--format', default='png', type=str, help='png, pdf, jpg')
# parser.add_argument('--save_dir', default='./rect', type=str, help='Save path')
# parser.add_argument('--gt_draw', dest='gt_draw', action="store_true", default=True)
...
parser.add_argument('--tracker_result_dir', type=str, default='E:/lwdm/SiamFDB-main/tools/results/UAV123/', help='tracker result root')
parser.add_argument('--trackers', nargs='+', default=["ours", "SiamCAR", "SiamFDB", "SiamGAT", "SiamPW-RBO"])
parser.add_argument('--format', default='png', type=str, help='png, pdf, jpg')
parser.add_argument('--save_dir', default='./rect/uav_trackers', type=str, help='Save path')
parser.add_argument('--gt_draw', dest='gt_draw', action="store_true", default=True)
