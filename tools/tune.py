...
from pysot.tracker.siamdmcf_tracker import SiamDMCFTracker
...
def objective(trial):
    ...
    # rebuild tracker
    tracker = SiamDMCFTracker(model, cfg.TRACK)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset_root', default='/home/yxy/gxy/testing_dataset', type=str, help='datasetdir')
    ...
    parser.add_argument('--snapshot', default='../snapshotAll/checkpoint_e13.pth', type=str,
    ...
    if args.dataset == "GOT-10k":
        root = os.path.join(args.dataset_root, "GOT-10k")
    else:
