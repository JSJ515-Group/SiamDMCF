...
parser.add_argument('--dataset_dir', type=str, default='D:\\sjj',# '../../dataset',
        help='datasets')
parser.add_argument('--dataset', type=str, default='UAV123',
        help='datasets')#OTB100 LaSOT UAV123 GOT-10k
parser.add_argument('--vis', action='store_true',default=True,
        help='whether visualzie result')
parser.add_argument('--snapshot', type=str, default='E:/lwdm/SiamFDB-main/snapshotAll/checkpoint_e1.pth',
        help='snapshot of models to eval')

parser.add_argument('--config', type=str, default='E:/lwdm/SiamFDB-main/experiments/SiamFDB_r50/config.yaml',
        help='config file')
